...
// All implementations should embed UnimplementedSayServer
// for forward compatibility
type SayServer interface {
	Hello(context.Context, *Request) (*Response, error)
}

// UnimplementedSayServer should be embedded to have forward compatible implementations.
...
var Say_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "tutorial/proto/hello/hello.proto",
}
